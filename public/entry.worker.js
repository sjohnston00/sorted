...
// routes-module:routes/api.childFeatureFlag.ts?worker
var require_api_childFeatureFlag = __commonJS({
  "routes-module:routes/api.childFeatureFlag.ts?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/api.markedHabit.$id.ts?worker
var require_api_markedHabit_id = __commonJS({
  "routes-module:routes/api.markedHabit.$id.ts?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/api.friendRequest.ts?worker
var require_api_friendRequest = __commonJS({
  "routes-module:routes/api.friendRequest.ts?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/api.featureFlag.ts?worker
var require_api_featureFlag = __commonJS({
  "routes-module:routes/api.featureFlag.ts?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/profile._index.tsx?worker
var require_profile_index = __commonJS({
  "routes-module:routes/profile._index.tsx?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/habits._index.tsx?worker
var require_habits_index = __commonJS({
  "routes-module:routes/habits._index.tsx?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/api.friend.ts?worker
var require_api_friend = __commonJS({
  "routes-module:routes/api.friend.ts?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/habits.$id.tsx?worker
var require_habits_id = __commonJS({
  "routes-module:routes/habits.$id.tsx?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/habits.new.tsx?worker
var require_habits_new = __commonJS({
  "routes-module:routes/habits.new.tsx?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/api.users.ts?worker
var require_api_users = __commonJS({
  "routes-module:routes/api.users.ts?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/sign-in.$.tsx?worker
var require_sign_in = __commonJS({
  "routes-module:routes/sign-in.$.tsx?worker"(exports, module) {
    module.exports = {};
  }
});

// routes-module:routes/sign-up.$.tsx?worker
var require_sign_up = __commonJS({
  "routes-module:routes/sign-up.$.tsx?worker"(exports, module) {
    module.exports = {};
  }
});
...
var route2 = __toESM(require_api_childFeatureFlag());
var route3 = __toESM(require_api_markedHabit_id());
var route4 = __toESM(require_api_friendRequest());
var route5 = __toESM(require_api_featureFlag());
var route6 = __toESM(require_profile_index());
var route7 = __toESM(require_habits_index());
var route8 = __toESM(require_api_friend());
var route9 = __toESM(require_habits_id());
var route10 = __toESM(require_habits_new());
...
var routes = {
  ...
  "routes/api.childFeatureFlag": {
    id: "routes/api.childFeatureFlag",
    parentId: "root",
    path: "api/childFeatureFlag",
    index: void 0,
    caseSensitive: void 0,
    module: route2
  },
  "routes/api.markedHabit.$id": {
    id: "routes/api.markedHabit.$id",
    parentId: "root",
    path: "api/markedHabit/:id",
    index: void 0,
    caseSensitive: void 0,
    module: route3
  },
  "routes/api.friendRequest": {
    id: "routes/api.friendRequest",
    parentId: "root",
  ...
  "routes/api.featureFlag": {
    id: "routes/api.featureFlag",
    parentId: "root",
  ...
  "routes/habits._index": {
    id: "routes/habits._index",
    parentId: "routes/habits",
    path: void 0,
    index: true,
    caseSensitive: void 0,
    module: route7
