...
export default function HabitButton({ habit, selectedDay }: HabitButtonProps) {
  ...
  return (
    <fetcher.Form method="post">
      ...
      <button
        className="py-4 px-2 rounded shadow border-2 text-center font-semibold text-lg tracking-wide disabled:opacity-30 disabled:cursor-not-allowed active:opacity-70 active:scale-90 transition"
        style={
          {
            color: habit.colour,
